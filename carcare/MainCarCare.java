...
public class MainCarCare{
	...
	public static void main(String[] args) throws InterruptedException {
		...
		System.out.println("Bem vindo ao CarCare. O sistema que gerencia o seu carro!");
		...
		for (int x = 0; x < 1; ) {		// O LAÇO "for" RODARA INFINITAMENTE ENQUANTO "x" FOR MENOR QUE "1"
			...
			if (verificaDigitado.equals("1")) { // AQUI VAMOS FAZER OS METODOS APOS O LOGIN
			...
			} else if(verificaDigitado.equals("2")) {		// AQUI VAMOS CRIAR UM NOVO LOGIN NA ARRAY, NAO PODE TER USUARIOS REPETIDOS
				...
				System.out.println("\n-----------Obrigado por usar o CarCare!-------------");
				
				login.mostraLogo();
				
				x = 1;
			}else {
				System.out.println("O numero informado nao corresponde a uma opçao!" + "\nDigite novamente!\n"
