		...
		private int anoModelo; 
	 	...
	 	public void verificaManutencao(int codVerificadorMain) {
	 		...
	 		for(i = 0; i < ArrayCarro.size(); i++) {
	 			if(digitado.equals(ArrayCarro.get(i).getModeloCarro()) && getCod() == ArrayCarro.get(i).getCod()) {
	 				...
	 				break;
	 			}else if(i == ArrayCarro.size() && digitado.equals(ArrayCarro.get(i).getModeloCarro())){
	 				System.out.println("O modelo nao existe!");
	 				break;
	 			}
	 		}
	 	}
