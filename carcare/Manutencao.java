...
public class Manutencao {
	...
	public void getTrocaOleo() {
		System.out.println("A diferença para a ultima vez é de: "+ (kmAtual - trocaOleo) + " km`s");
		
		if (trocaOleo < kmAtual && kmAtual - trocaOleo >= 5000) {

			System.out.println("\n____Voce deve trocar o oleo");
			if (kmAtual - trocaOleo >= 10000) {
				System.out.println("____Voce deve trocar o filtro de oleo");
			}
		} else {
